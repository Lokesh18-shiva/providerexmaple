...
class DalsPage extends StatefulWidget {
  const DalsPage({Key? key}) : super(key: key);

  @override
  State<DalsPage> createState() => _DalsPageState();
}

class _DalsPageState extends State<DalsPage> {
