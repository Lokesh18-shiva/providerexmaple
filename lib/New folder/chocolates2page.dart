...
class  ChocolatesPage2 extends StatefulWidget {
  const ChocolatesPage2({Key? key}) : super(key: key);

  @override
  State<ChocolatesPage2> createState() => _ChocolatesPage2State();
}

class _ChocolatesPage2State extends State<ChocolatesPage2> {
